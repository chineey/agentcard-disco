...
def to_markdown(report: ScoreReport) -> str:
    ...
    # Header
    lines += [
        f"# Agent Card Discoverability Report",
        f"",
    ...
    if suggestions:
        lines += [
            ...
            f"",
            f"| Priority | Dimension | Field | Action |",
            f"|:--------:|-----------|-------|--------|",
        ]
    ...
    if high:
        lines += [
            ...
            f"this card to an A2A registry.",
            f"",
        ]
        ...
        lines += [
            f"---",
            f"",
            f"> ✅ This card is ready to publish to an A2A registry.",
            f"",
        ]

    lines += [
        f"---",
        f"*Generated by [agentcard-disco](https://github.com/chinemeze/agentcard-disco)*",
    ]
